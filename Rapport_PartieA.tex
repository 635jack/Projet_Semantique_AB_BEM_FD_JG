...
\texttt{dev\_preprocessed.csv} & CSV & $\sim$4 MB \\
\texttt{test\_preprocessed.csv} & CSV & $\sim$4 MB \\
\texttt{tfidf\_matrix.npz} & NumPy sparse & 1.96 MB \\
\texttt{tfidf\_matrix\_dev.npz} & NumPy sparse & $\sim$0.4 MB \\
\texttt{tfidf\_matrix\_test.npz} & NumPy sparse & $\sim$0.4 MB \\
